 ...
 */
class Element_SetupNotifications(context: Context, attrs: AttributeSet?) : ConstraintLayout(context, attrs) {
	...
	init {
		View.inflate(context, R.layout.element_setup_notifications, this)
		
		container = findViewById(R.id.container)
		
		val theme = context.theme.obtainStyledAttributes(attrs, R.styleable.Element_SetupNotifications, 0, 0)
